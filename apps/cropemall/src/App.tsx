...
function App() {
    ...
    return (
        <div className="relative flex h-screen bg-white">
            ...
            {files.length > 0 && (
                <div className="absolute p-2 rounded bg-mf-200 bottom-4 right-8">
                    {/* control + wheel to zoom info */}
                    <p className="text-black">ctrl + wheel to zoom</p>

                    <div className="flex flex-row gap-2 rounded bg-mf-200 bottom-4 right-8 mt-2">
                        <button
                            onClick={crop}
                            title="Crop all"
